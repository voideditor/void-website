...
You might have noticed that Void lets you use any LLM model you like!
...
- **Others:** As long as your endpoint is OpenAI-compatible, Void lets you connect with it. SillyTavern, LMStudio, LiteLM, etc.
